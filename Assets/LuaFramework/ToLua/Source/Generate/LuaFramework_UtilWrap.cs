...
public class LuaFramework_UtilWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("RecordStartTime", RecordStartTime);
		L.RegFunction("EndRecordTime", EndRecordTime);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int RecordStartTime(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			string arg0 = ToLua.CheckString(L, 1);
			LuaFramework.Util.RecordStartTime(arg0);
			return 0;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int EndRecordTime(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			string arg0 = ToLua.CheckString(L, 1);
			LuaFramework.Util.EndRecordTime(arg0);
			return 0;
		}
		catch (Exception e)
		{
